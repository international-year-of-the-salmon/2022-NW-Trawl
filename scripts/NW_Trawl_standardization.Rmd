...
download.file("https://github.com/international-year-of-the-salmon/2022-NW-Data-Template/blob/main/IYS2022_NW_Data.xlsx?raw=true", here::here("IYS_data_template", "IYS2022_NW_Data_V1.xlsx"), quiet = TRUE, mode = "wb")

event <- read_excel("C:/Users/Admin/Desktop/GitHub/2022-NW-Trawl/IYS_data_template/IYS2022_NW_Data_V1.xlsx", sheet = "Sampling_Event_Info")
```
...
occurrence_allCatch <- read_excel("C:/Users/Admin/Desktop/GitHub/2022-NW-Trawl/IYS_data_template/IYS2022_NW_Data_v1.xlsx", sheet = "Catch_Info")
...
NW2022_trawl_allCatch_eMOF <- NW2022_trawl_allCatch_eMOF %>%
  mutate(measurementID = paste0(occurrenceID, measurementType, sep = ":"),
         ...
         measurementValueID = case_when(
           ...
           measurementValue == "Immature" ~ " ",
           measurementValue == "Larval" ~ " ",
           measurementValue == "Age 1+" ~ " ")) %>%
